...
## Disponibilizar bens
Descrição: O proprietário insere na aplicação os bens alimentares que pretende disponibilizar.
## Pré-condições:
...
Descrição: A empresa recebe a notificação que o produto foi inserido e que empresa o inseriu
## Pré-condições:
* notificações ativas
Passo a passo:
...
## Recolha do produto
Descrição: A empresa informa que se vai deslocar para recolher os bens
## Pré-condições:
- Estar logado
Passo a passo:
